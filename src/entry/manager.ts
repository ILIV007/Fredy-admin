...
<div class="sidebar" id="sidebar"><div class="sidebar-header"><div class="logo">🤖</div><div><h1>Fredy</h1><div class="ver">v14.0.7 · ALL-PATH-FALLBACK</div></div></div><div class="sidebar-nav" id="nav"></div></div>
